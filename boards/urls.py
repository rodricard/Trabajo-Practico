...
urlpatterns = [
    ...
    path('<int:pk>/actividad/', views.board_activity, name='board_activity'),
    ...
    path('labels/<int:pk>/eliminar/', views.label_delete, name='label_delete'),
    ...
    path('comentarios/<int:pk>/editar/', views.comment_edit, name='comment_edit'),
